...
This version (1.43.1) of the Pact standalone executables package contains:

  * pact gem 1.26.0
  * pact-mock_service gem 2.7.1
  * pact-support gem 1.6.0
  * pact-provider-verifier gem 1.14.3
  * pact_broker-client gem 1.14.1
  * pact-message gem 0.4.4
